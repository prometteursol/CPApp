...
public class ComboAppDetailsServicesAdapter extends RecyclerView.Adapter<ComboAppDetailsServicesAdapter.ViewHolder> {
    ...
    boolean bottomlist;
    List<ReschduleGetDataBean.ComboService> results;

    public ComboAppDetailsServicesAdapter(AppCompatActivity nActivity, List<ReschduleGetDataBean.ComboService> results, boolean bottomlist) {
