...
public class ComboListRequestAppDetailsAdapter extends RecyclerView.Adapter<ComboListRequestAppDetailsAdapter.ViewHolder> {

    AppCompatActivity nActivity;

    boolean bottomlist;
    List<OngoingBean.ComboService> results;

    public ComboListRequestAppDetailsAdapter(AppCompatActivity nActivity, List<OngoingBean.ComboService> results, boolean bottomlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ComboListRequestAppDetailsAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
            ...
            holder.recycleComboServicesOffers.setAdapter(new ComboRequestServicesAdapter(nActivity, results.get(position).getServices(), false));
