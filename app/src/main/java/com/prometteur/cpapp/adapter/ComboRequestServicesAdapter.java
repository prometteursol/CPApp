...
public class ComboRequestServicesAdapter extends RecyclerView.Adapter<ComboRequestServicesAdapter.ViewHolder> {

    AppCompatActivity nActivity;

    boolean bottomlist;
    List<OngoingBean.Service> results;

    public ComboRequestServicesAdapter(AppCompatActivity nActivity, List<OngoingBean.Service> results, boolean bottomlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ComboRequestServicesAdapter.ViewHolder(view);
    }
