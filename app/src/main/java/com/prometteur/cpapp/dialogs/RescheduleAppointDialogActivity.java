...
public class RescheduleAppointDialogActivity extends AppCompatActivity implements OnTimeslotItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Date appDate = simpleDateFormat.parse(getIntent().getStringExtra("appDate"));
   ...
   RecyclerView recycleComboSelected,recyclePromoOffSelected,recycleServicesSelected;
    ...
    private void initAdapter() {
        nActivity=RescheduleAppointDialogActivity.this;
        // for time slot
        mLayoutManager = new GridLayoutManager(RescheduleAppointDialogActivity.this, 4);
        ...
        timeSlotAdapter = new TimeSlotAdapter(RescheduleAppointDialogActivity.this, timeSlots, this, getIntent().getStringExtra("appTime"));
...
if(ongoingBean.getServices().size()==0)
{
    tvTitle.setVisibility(View.GONE);
        ...
        //combo list
        recycleComboSelected.setLayoutManager(new LinearLayoutManager(RescheduleAppointDialogActivity.this));
        recycleComboSelected.setAdapter(new ComboListAppDetailsAdapter(RescheduleAppointDialogActivity.this,combos,false));
        //promo offer list
        recyclePromoOffSelected.setLayoutManager(new LinearLayoutManager(RescheduleAppointDialogActivity.this));
        recyclePromoOffSelected.setAdapter(new PromoOffListAppDetailsAdapter(RescheduleAppointDialogActivity.this,offers,false));
        //single services list
        recycleServicesSelected.setLayoutManager(new LinearLayoutManager(RescheduleAppointDialogActivity.this));
        recycleServicesSelected.setAdapter(new ServiceSelectedAdapter(RescheduleAppointDialogActivity.this,ongoingBean.getServices()));
   ...
   /* private void setServiceSpinner() {
        ...
        for (int i = 0; i < services.size(); i++) {
            ...
            keyPairBoolData.setName(services.get(i).getSrvcName());
            listArray3.add(keyPairBoolData);
        }


        spServices.setItems(listArray3, 0, new SpinnerListener() {
            ...
            public void onItemsSelected(List<KeyPairBoolData> items) {
                ...
                for (int i = 0; i < items.size(); i++) {
                    if (items.get(i).isSelected()) {
                        Log.i("Service", i + " : " + items.get(i).getName() + " : " + items.get(i).isSelected());
                        serviceId = services.get(i).getSrvcId();
                        mDataList = services.get(i).getOperators();

                        position = i;
                        //for operator against service
                        mLayoutManager1 = new LinearLayoutManager(RescheduleAppointDialogActivity.this, RecyclerView.HORIZONTAL, false);
                        recyclerViewOperator.setLayoutManager(mLayoutManager1);
                        operatorAdapter = new OperatorAdapter(RescheduleAppointDialogActivity.this, mDataList, RescheduleAppointDialogActivity.this, services.get(position).getAptserOperatorId());
                        recyclerViewOperator.setAdapter(operatorAdapter);
                    }
                }
            }
        });
    ...
    private void getRescheduleGetData(String day) {
        ...
        final Dialog progressDialog = showProgress(RescheduleAppointDialogActivity.this, 0);
        progressDialog.show();
        service.getRescheduleGetData(getIntent().getStringExtra("appointmentId"), day)
                ...
                .subscribe(new Observer<ReschduleGetDataBean>() {
                    ...
                    public void onError(Throwable e) {
                        progressDialog.dismiss();
                        showFailToast(RescheduleAppointDialogActivity.this,  getResources().getString(R.string.went_wrong));
                    }
                    ...
                    public void onComplete() {
                        ...
                        if (ongoingBean.getStatus() == 1) {
                            ...
                            showFailToast(RescheduleAppointDialogActivity.this,  "" + ongoingBean.getMsg());
                            logout(RescheduleAppointDialogActivity.this);
                        }
