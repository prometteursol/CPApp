...
import com.prometteur.cpapp.adapter.TopServiceDetailsAdapter;
import com.prometteur.cpapp.beans.ProfileBean;

import java.util.ArrayList;
import java.util.List;

import static com.prometteur.cpapp.profile.ProfileActivity.topItem;
...
public class ServicesProfileFragment extends BottomSheetDialogFragment {
    ...
    ImageView ivClose;
    private List<ProfileBean.Service> mDataList = new ArrayList<>();
