package com.prometteur.cpapp.utils.spinner;
...
public class SingleSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public void setItems(List<KeyPairBoolData> items, int position, SingleSpinnerListener listener) {
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (data.isSelected()) {
                ...
                convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.skyBlueLight));
            }
            return convertView;
        }
